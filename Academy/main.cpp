...
#define STUDENT_TAKE_PARAMETERES const const std::string& speciality, const std::string& group, double rating, double attendance
...
public:
	...
	//					Constructors:
	Student(HUMAN_TAKE_PARAMETERS,STUDENT_TAKE_PARAMETERES):Human(HUMAN_GIVE_PARAMETERS)
	{
